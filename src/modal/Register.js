...
export default function Register({ showRegister, handleClose }) {
                    ...
                    <div className='login-container'>
                        ...
                        <div className='login-layout'>
                            ...
                            <div>
                                ...
                                <div className='input-div'>
                                    <input
                                        ...
                                        className={`h-45 form-input dark-black ${((isSubmitted && !signupData.name) || (signupData.name && !isNameValid(signupData.name))) ? 'input-error' : ''}`}
                                    />
                                </div>

                                {isSubmitted && !signupData.fname && <p className='mb-0 text-error'>Name is required.</p>}
                            ...
                            <div>
                                ...
                                {isSubmitted && !signupData.lname && <p className='mb-0 text-error'>Name is required.</p>}
                            ...
                            <div>
                                <p className='mb-0 mt-30 dark-black letter-spacing-32'>Password</p>
                                <div className='input-div'>
                                    <input
                                        type="password"
                                        name="password"
                            ...
                            <span className='mt-15 fs-12'>* By Providing mobile no, I am agreeing to <a className='primary-blue'>T&C</a>.</span>

                            <div className='border-div'></div>
                            <div
                                className='mt-20 light-dark font-weight-400 line-height-24'
                            >
